...
class Ui(object):
    ...
    def __init__(self, window):
        ...
        self.next_button.clicked.connect(self.clear_function)
    ...
    def re_translate_ui(self, window):
        ...
        self.message_label.setText(_translate("mainWindow", "Enter branch " + chr(self.sequence) + " details"))
        ...
        self.next_button.setText(_translate("mainWindow", "Next Branch"))
    ...
    def clear_function(self):
        for text_box in self.text_boxes:
            text_box.clear()
        self.sequence += 1
        self.message_label.setText("Enter branch  " + chr(self.sequence) + " details")
